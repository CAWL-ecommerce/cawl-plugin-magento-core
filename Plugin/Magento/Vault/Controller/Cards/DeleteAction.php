...
namespace Cawl\PaymentCore\Plugin\Magento\Vault\Controller\Cards;
...
class DeleteAction
{
    private const CAWL_PAYMENT_CODE_PREFIX  = 'worldline';
    ...
    public function beforeExecute(MagentoDeleteAction $subject): void
    {
        ...
        if (strpos($paymentToken->getPaymentMethodCode(), self::CAWL_PAYMENT_CODE_PREFIX) !== 0) {
            return;
        }
