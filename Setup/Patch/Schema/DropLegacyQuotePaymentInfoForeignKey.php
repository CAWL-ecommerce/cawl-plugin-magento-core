...
namespace Cawl\PaymentCore\Setup\Patch\Schema;

use Magento\Framework\Setup\ModuleDataSetupInterface;
use Magento\Framework\Setup\Patch\SchemaPatchInterface;

/**
 * Drops the foreign key on cawl_quote_payment_information.payment_id ->
 * quote_payment.payment_id regardless of the constraint's actual name in the
 * live database.
 *
 * Older Cawl plugin versions created this constraint with auto-generated
...
{
    private const TABLE_NAME = 'cawl_quote_payment_information';
